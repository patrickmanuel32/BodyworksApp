  ...
  render() {
    ...
    return (
      <Block flex style={styles.container}>
        ...
        <Block flex>
          <ImageBackground
            source={{uri: 'https://i.imgur.com/kBdIMBy.jpg'}}
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Block >
                <Block>
                  <Text color="white" size={60}>BODY</Text>
                </Block>
                <Block>
                  <Text color="white" size={60}>WORKS</Text>
                </Block>
                <Block row>
              ...
              <Text size={16} color='rgba(255,255,255,0.6)' style={{ marginTop: 35 }}>
                Thank you for availing our free trial! Kindly subscribe for monthly information and tutorial of our workout. :) 
              </Text>
              ...
              <Button
                ...
                <Text bold color={theme.COLORS.WHITE}>SUBSCRIBE NOW</Text>
              </Button>
            </Block>
          </Block>
        </Block>
